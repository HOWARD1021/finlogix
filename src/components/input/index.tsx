      ...
      <div className='inputContent'>
        <div className="p-4  bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6" action="#">
            <div className="text-xl font-medium text-gray-900 dark:text-white">Register for a Webinar now</div>
            <p className="text-sm font-medium text-gray-900 dark:text-white">Please fill in the form below and you will be contacted within 1 working day by our professional business experts.</p>
            <div>
